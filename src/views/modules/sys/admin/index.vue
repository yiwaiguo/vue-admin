  ...
  <div class="page-container">
    <div class="show-box" v-show="!switchForm">
      ...
      <div class="btn-box">
        ...
        <el-button type="primary" icon="el-icon-edit" @click="uptDraPwd">审批密码设置</el-button>
        <el-button type="primary" icon="el-icon-edit" @click="reset">审批密码重置</el-button>
      </div>
      <div class="tb-box">
        <el-table
          :data="tableData"
        ...
        >
          ...
          <el-table-column prop="traPwd" label="审批密码" align="center"></el-table-column>
    ...
    <div class="form-section" v-show="switchForm">
      ...
      <div class="form-container">
        <el-form ref="form" :model="user" label-width="100px">
          <el-form-item label="用户名">
            <el-input v-model="user.username" placeholder="登录账号"></el-input>
          </el-form-item>
          ...
          <el-form-item label="所属服务商" v-show="showDealers">
          ...
          <el-form-item label="所属机构" v-show="showOrgSelect">
            <input v-model="user.orgId" placeholder="请点击查询所属机构" @click="showOrgTree" class="input">
            <el-button type="primary" @click="cancelOrg">取消选择</el-button>
          </el-form-item>
          <el-form-item label="选择机构" v-show="showOrgList">
            <ul id="menuTree" class="ztree"></ul>
          </el-form-item>
          <el-form-item label="超管子账号">
            <el-checkbox-group v-model="user.userType">
