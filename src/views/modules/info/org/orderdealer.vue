      ...
      <div class="tb-box1">
        <div class="query-section">
          <el-form :inline="true" :model="q" class="demo-form-inline">
            <el-form-item label="订货分部名称">
              <el-input v-model="q.dealerName" placeholder="订货分部名称"></el-input>
            </el-form-item>
            <el-form-item label="订货分部编号">
              <el-input v-model="q.dealerCode" placeholder="订货分部编号"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <div class="tb-section">
          ...
          >
            ...
            <el-table-column prop="dealerName" label="订货分部名称"></el-table-column>
            <el-table-column prop="dealerFullName" label="订货分部全称"></el-table-column>
            <el-table-column prop="dealerCode" label="订货分部编号"></el-table-column>
  ...
  methods: {
    async query() {
      ...
      let r = await this._fetch(
        "/org/dealer/orderList?limit=50&page=1" + this.queryParams,
        { method: "GET" }
      );
      if (r.code === 0) {
