  ...
  methods: {
    ...
    download() {
      ...
      fetch(this.baseURL + this.url, {
        ...
        res.blob().then(blob => {
          var filename = `服务商${keyword}日结明细表.xls`;
    ...
    async handleSizeChange(val) {
      let r = await this._fetch(
        "/bountyDailySettlement/dealerList?limit=" + val + "&page=" + this.page.currentPage,
        { method: "GET" }
      );
      this.tableData = r.page.list;
    ...
    async handleCurrentChange(val) {
      let r = await this._fetch(
        "/bountyDailySettlement/dealerList?limit=" + this.page.pageSize + "&page=" + val,
        { method: "GET" }
      );
      this.tableData = r.page.list;
